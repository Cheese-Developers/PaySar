...
const UserInfoProfile = ({
  ...
  return (
    <div className="pt-12 w-[65%] mx-auto">
      <div className="user-information bg-slate-900 rounded-lg shadow-2xl text-secondary font-medium flex flex-col justify-center items-center gap-6 w-[60%] mx-auto py-10">
